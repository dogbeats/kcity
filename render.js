...
function drawScene(gl, programInfo, buffers, texture, deltaTime) {
  ...
  mat4.perspective(projectionMatrix,
                   ...
                   zFar);
				   	...
				   	for(var i = 0; i < 2; i++)//switch to look at buffer size
	{	
  ...
  mat4.translate(modelViewMatrix,     // destination matrix
                 ...
                 [-playerTranslation[i][0], playerTranslation[i][1], -6.0]);  // amount to translate
...
document.getElementsByTagName('body')[0].onkeydown = function(e) {KeyPress(e)};
	var info = {
		newPosX:playerTranslation[0][0],
		newPosY:playerTranslation[0][1]
	};
function KeyPress(e) {
	console.log(e);
	switch(e.keyCode){
		case 87: //w
			playerTranslation[0][1]+=0.05;
			break;
		case 65: //a
			playerTranslation[0][0]+=0.05;
			break;
		case 83: //s
			playerTranslation[0][1]-=0.05;
			break;
		case 68: //d
			...
			break;
		case 38: //up arrow
			playerTranslation[1][1]+=0.05;
			break;
		case 37: //left arrow
			playerTranslation[1][0]+=0.05;
			break;
		case 40: //down arrow
			playerTranslation[1][1]-=0.05;
			break;
